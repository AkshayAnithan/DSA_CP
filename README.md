...
![Progress](https://progress-bar.xyz/24/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-03-09` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `9 / 28` | `12 / 101` | `2 / 21` |
| **Progress** | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱` | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `28` | `51%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `27` | `49%` |

_Last auto-update: 2026-07-30 14:00 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
...
| 18 | [Bit Manipulation](#18-bit-manipulation) | 7 | `▰▰▱▱▱▱▱` 2/7 |
