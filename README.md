...
![Progress](https://progress-bar.xyz/29/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 🔥 **Current streak** | `3 days` | keep alive |
| 🏆 **Longest streak** | `3 days` | beat it |
| ⏱️ **Avg time / problem** | `not tracked yet` | `< 30 min` |
| 🔁 **Solved without hints** | `0` | maximize |
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-02-16` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `9 / 28` | `14 / 101` | `3 / 21` |
| **Progress** | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱` | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `36` | `57%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `27` | `43%` |

_Last auto-update: 2026-08-04 18:54 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
