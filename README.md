...
![Progress](https://progress-bar.xyz/17/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-06-10` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `8 / 28` | `7 / 101` | `2 / 21` |
| **Progress** | `▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱` | `▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `14` | `35%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `26` | `65%` |

_Last auto-update: 2026-07-28 12:09 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
...
|:-:|:--|:-:|:-:|
| 1 | [Arrays & Hashing](#1-arrays--hashing) | 9 | `▰▱▱▱▱▱▱▱▱` 1/9 |
...
| 18 | [Bit Manipulation](#18-bit-manipulation) | 7 | `▰▱▱▱▱▱▱` 1/7 |
