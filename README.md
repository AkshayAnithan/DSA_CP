...
![Progress](https://progress-bar.xyz/38/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-03-04` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `10 / 28` | `21 / 101` | `4 / 21` |
| **Progress** | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱` | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `55` | `67%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `27` | `33%` |

_Last auto-update: 2026-08-22 11:06 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
...
| 5 | [Binary Search](#5-binary-search) | 7 | `▰▰▰▰▱▱▱` 4/7 |
