...
![Progress](https://progress-bar.xyz/23/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-03-18` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `9 / 28` | `11 / 101` | `2 / 21` |
| **Progress** | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱` | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `27` | `50%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `27` | `50%` |

_Last auto-update: 2026-07-30 13:01 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
...
|:-:|:--|:-:|:-:|
| 1 | [Arrays & Hashing](#1-arrays--hashing) | 9 | `▰▰▰▰▰▱▱▱▱` 5/9 |
