...
![Progress](https://progress-bar.xyz/37/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 🎯 **Solved** | `37 / 150` | `150` |
| 📅 **Days active** | `23` | — |
| 📈 **Avg / day** | `0.61 behind` | `>= 2.0` |
| 🔥 **Current streak** | `1 days` | keep alive |
| 🏆 **Longest streak** | `5 days` | beat it |
| ⏱️ **Avg time / problem** | `not tracked yet` | `< 30 min` |
| 🔁 **Solved without hints** | `0` | maximize |
| 📅 **Started** | `2026-06-19` | — |
| 🏁 **ETA at current pace** | `2027-02-20` | — |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `10 / 28` | `20 / 101` | `4 / 21` |
| **Progress** | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱` | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `52` | `66%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `27` | `34%` |

_Last auto-update: 2026-08-18 11:58 · Run `Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
...
|:-:|:--|:-:|:-:|
| 1 | [Arrays & Hashing](#1-arrays--hashing) | 9 | `▰▰▰▰▰▰▱▱▱` 6/9 |
| 2 | [Two Pointers](#2-two-pointers) | 5 | `▰▱▱▱▱` 1/5 |
| 3 | [Sliding Window](#3-sliding-window) | 6 | `▱▱▱▱▱▱` 0/6 |
| 4 | [Stack](#4-stack) | 7 | `▰▰▰▰▰▱▱` 5/7 |
| 5 | [Binary Search](#5-binary-search) | 7 | `▰▰▰▱▱▱▱` 3/7 |
| 6 | [Linked List](#6-linked-list) | 11 | `▱▱▱▱▱▱▱▱▱▱▱` 0/11 |
| 7 | [Trees](#7-trees) | 15 | `▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰` 15/15 |
...
| 18 | [Bit Manipulation](#18-bit-manipulation) | 7 | `▰▰▰▰▱▱▱` 4/7 |
