...
![Progress](https://progress-bar.xyz/0/?scale=150&title=Solved&width=500&color=00b894&suffix=%20/%20150)
...
| 🏆 **Longest streak** | `0 days` | beat it |
| ⏱️ **Avg time / problem** | `—` | `< 30 min` |
| 🔁 **Solved without hints** | `0` | maximize |
| 📅 **Started** | `TBD` | — |
| 🏁 **ETA at current pace** | `—` | `2026-09-15` |

### By difficulty

| | 🟢 Easy | 🟡 Medium | 🔴 Hard |
|:--|:-:|:-:|:-:|
| **Solved** | `0 / 40` | `0 / 80` | `0 / 30` |
| **Progress** | `▱▱▱▱▱` | `▱▱▱▱▱▱▱▱▱▱` | `▱▱▱▱▱` |
...
|:--|:-:|:-:|
| ![cpp](https://img.shields.io/badge/-C++-00599C?style=flat-square&logo=cplusplus&logoColor=white) | `0` | `0%` |
| ![cs](https://img.shields.io/badge/-C%23-239120?style=flat-square&logo=csharp&logoColor=white) | `0` | `0%` |

_Last auto-update: never · Run `.\Update-Stats.ps1` to refresh._
<!-- AUTO:STATS:END -->
